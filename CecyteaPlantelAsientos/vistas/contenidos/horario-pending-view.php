...
<div class="full-box page-header">
    <h3 class="text-left">
        <i class="fas fa-hand-holding-usd fa-fw"></i> &nbsp; COLGIATURA
    </h3>
...
<div class="container-fluid">
    <ul class="full-box list-unstyled page-nav-tabs">
        <li>
            <a href="<?php echo SERVERURL; ?>reservacion-cita/"><i class="fas fa-plus fa-fw"></i> &nbsp; NUEVO PAGO</a>
        </li>
        <li>
            <a href="<?php echo SERVERURL; ?>horario-new/"><i class="far fa-calendar-alt"></i> &nbsp; RESERVACIONES DE CITA</a>
        </li>
        <li>
            <a class="active" href="<?php echo SERVERURL; ?>horario-pending/"><i class="fas fa-hand-holding-usd fa-fw"></i> &nbsp; PAGOS</a>
        </li>
        <li>
            <a href="<?php echo SERVERURL; ?>horario-new/"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; FINALIZADOS</a>
        </li>
        <li>
		...
		<table class="table table-dark table-sm">
			...
			<tbody>
				<tr class="text-center" >
					...
					<td>2017/10/8</td>
					<td>2017/10/10</td>
					<td><span class="badge badge-info">Pagos</span></td>
