...
<div class="container-fluid">
    <ul class="full-box list-unstyled page-nav-tabs">
        <li>
            <a href="<?php echo SERVERURL; ?>docente-new/"><i class="fas fa-plus fa-fw"></i> &nbsp; AGREGAR DOCENTES</a>
        </li>
        <li>
		...
		<table class="table table-dark table-sm">
			...
			<tbody>
				<tr class="text-center" >
					...
					<td>
                        <a href="<?php echo SERVERURL; ?>docente-update/" class="btn btn-success">
