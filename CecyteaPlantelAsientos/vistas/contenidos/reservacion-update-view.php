...
<div class="full-box page-header">
    <h3 class="text-left">
        <i class="fas fa-sync-alt fa-fw"></i> &nbsp; ACTUALIZAR PAGOS
    </h3>
...
<div class="container-fluid">
    <ul class="full-box list-unstyled page-nav-tabs">
        <li>
            <a href="<?php echo SERVERURL; ?>horario-new/"><i class="fas fa-plus fa-fw"></i> &nbsp; NUEVO PAGO</a>
        </li>
        <li>
            <a href="<?php echo SERVERURL; ?>reservacion-cita/"><i class="far fa-calendar-alt"></i> &nbsp; RESERVACIONES</a>
        </li>
        <li>
            <a href="<?php echo SERVERURL; ?>horario-pending/"><i class="fas fa-hand-holding-usd fa-fw"></i> &nbsp; PAGOS</a>
        </li>
        <li>
            <a href="<?php echo SERVERURL; ?>horario/"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; FINALIZADOS</a>
        </li>
        <li>
...
<div class="container-fluid">
    ...
    <div class="container-fluid form-neon">
        <div class="container-fluid">
            <p class="text-center roboto-medium">AGREGAR NUEVO PAGO A ESTE SEMESTRE</p>
        ...
        <div class="container-fluid">
            <div>
                <span class="roboto-medium">Institucion:</span> 
            ...
            <fieldset>
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                <label for="prestamo_hora_inicio">Hora de pago</label>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12 col-md-4">
                            <div class="form-group">
                                <label for="prestamo_estado" class="bmd-label-floating">*** Estado de cuenta ***</label>
                                <select class="form-control" name="prestamo_estado_up" id="prestamo_estado">
                                    <option value="Reservacion">Reservación</option>
                                    <option value="Prestamo">PAGO</option>
