...
<div class="container-fluid">
    <ul class="full-box list-unstyled page-nav-tabs">
        <li>
            <a href="<?php echo SERVERURL; ?>horario-new/"><i class="fas fa-plus fa-fw"></i> &nbsp; NUEVO PAGOS</a>
        </li>
        <li>
            <a href="<?php echo SERVERURL; ?>horario/"><i class="far fa-calendar-alt"></i> &nbsp; RESERVACIONES</a>
        </li>
        <li>
            <a href="<?php echo SERVERURL; ?>horario-pending/"><i class="fas fa-hand-holding-usd fa-fw"></i> &nbsp; PAGOS</a>
        </li>
        <li>
            <a class="active" href="<?php echo SERVERURL; ?>reservacion-cita/"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; FINALIZADOS</a>
        </li>
        <li>
		...
		<table class="table table-dark table-sm">
			...
			<tbody>
				<tr class="text-center" >
					...
					<td>
						<a href="<?php echo SERVERURL; ?>reservacion-update/" class="btn btn-success">
